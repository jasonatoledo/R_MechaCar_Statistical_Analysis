...
#Deliverable 3
t.test(df2$PSI)
t.test(subset(df2, Manufacturing_Lot == "Lot1", select = PSI))
t.test(subset(df2, Manufacturing_Lot == "Lot2", select = PSI))
t.test(subset(df2, Manufacturing_Lot == "Lot3", select = PSI))
